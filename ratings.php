...
$titles = imdb()->getRatedTitles($pager = new Pager(limit: 100, cursor: $cursor));
// dump(imdb());
// $titles = [...$titles, ...imdb()->getTitleRatings(page: 2)];
...
<p><span id="showing-num"><?= count($titles) ?></span> / <?= imdb()->ratedlist->count ?>:</p>
